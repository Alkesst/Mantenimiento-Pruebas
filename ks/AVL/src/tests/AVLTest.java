...
/*
	Los m�todos equals(), hashCode() y compareTo() no est�n implementados y deberian estarlo.
	Los test de compareTo() ni siquiera se pueden realizar ya que no es posible llamar a la funci�n.
